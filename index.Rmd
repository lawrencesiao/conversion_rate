...
```
```{r echo=FALSE}
data$new_user = as.integer(as.character(data$new_user))
data$converted = as.integer(as.character(data$converted))
```
1. seems a U.S. site
...
---
## EDA - country
```{r message=FALSE,,out.width="480px"}
...
---
## EDA - new_user
```{r message=FALSE,,out.width="350px"}
...
---
## EDA - age
```{r eval=FALSE,message=FALSE,,out.width="400px"}
...
---
## EDA - age vs. country
```{r eval=FALSE,message=FALSE,out.width="480px"}
